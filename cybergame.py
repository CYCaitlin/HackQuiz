...
button_a = Tk.Radiobutton(window, text = 'Temp A', variable = val, value = 'a', indicatoron = 0, width = 300, padx = 20)
button_b = Tk.Radiobutton(window, text = 'Temp B', variable = val, value = 'b', indicatoron = 0, width = 300, padx = 20)
button_c = Tk.Radiobutton(window, text = 'Temp C', variable = val, value = 'c', indicatoron = 0, width = 300, padx = 20)
button_d = Tk.Radiobutton(window, text = 'Temp D', variable = val, value = 'd', indicatoron = 0, width = 300, padx = 20)
